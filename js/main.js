let app = new Vue({
    ...
    methods: {
        ...
        endGame() {
            ...
            //protoss
            else if (this.score.protoss > this.score.zerg && this.score.protoss > this.score.terran && this.score.taldarin > 3 && Math.abs(this.score.protoss - this.score.zerg) > 3) {
    ...
    computed: {
        ...
        showResultRace() {
            return {
                ...
                'taldarin': this.totalGame.taldarin > 0 ? true : false,
